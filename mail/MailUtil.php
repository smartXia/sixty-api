...
class MailUtil {
    ...
    public $fromMailPass = 'liulin60';
    public $charSet = 'UTF-8';
    public $SMTPSecure = 'tls';
    public $port = 587;

    // Sender(发件人)
    public $senderName = 'Sixty';
    ...
    function send () {
        ...
        try {
            ...
            $mail->Port = 994;                        // TCP port to connect to(要连接的TCP端口) 常用邮箱的 SMTP 地址和端口参见：https://blog.wpjam.com/m/gmail-qmail-163mail-imap-smtp-pop3/
